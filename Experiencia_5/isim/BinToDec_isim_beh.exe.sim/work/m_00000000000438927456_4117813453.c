...
LAB16:    t157 = (t0 + 28320);
    ...
    *((unsigned int *)t167) = (t169 | t163);
    xsi_driver_vfirst_trans(t157, 32, 35);
    t170 = (t0 + 27392);
    *((int *)t170) = 1;
...
LAB18:    t65 = (t0 + 28384);
    ...
    *((unsigned int *)t75) = (t77 | t71);
    xsi_driver_vfirst_trans(t65, 9, 9);
    t78 = (t0 + 27408);
    *((int *)t78) = 1;
